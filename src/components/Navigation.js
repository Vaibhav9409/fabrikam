                ...
                {window.localStorage.getItem("user_role") !== "DELIVERY_BOY" &&
                  ...
                  window.localStorage.getItem("user_role") !== "SUPPLIER" && (
                    <li className="nav-item">
                      <Link to="/home">
                        <a className="nav-link nameColor2">
                          <h5>Home</h5>
                        </a>
                      </Link>
                    </li>
              ...
              <ul className="nav justify-content-end">
                  ...
                  window.localStorage.getItem("user_role") !== "SUPPLIER" && (
                    <Link to="/cart">
                      <li class="nav-link">
                        ...
                        >
                          <h5>
                            <i class="fas fa fa-shopping-cart fa-lg">Cart</i>
                          </h5>
                  ...
                  <li className="nav-item">
                    <Link to="/create-account">
                      <a className="nav-link">
                        <h5 className="nameColor2">Sign Up</h5>
                      </a>
                    </Link>
                  </li>
                )}
                {!this.state.st && (
                  <li className="nav-item">
                    <Link to="/login">
                      <a className="nav-link">
                        <h5 className="nameColor2">Login</h5>
                      </a>
                    </Link>
                  </li>
                )}
