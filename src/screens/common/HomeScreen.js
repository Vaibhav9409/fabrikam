  ...
  render() {
    return (
      <div className="HomeScreen">
            ...
            >
              ...
              <div className="carousel-inner">
                <div className="carousel-item active" data-bs-interval="2000">
                  <Link to="/home">
                    <img
                      src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1648710920_Summer-Fashion-1680x320.jpg"
                ...
                <div className="carousel-item" data-bs-interval="2000">
                  <img
                    src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1649446295_April-9th_Banner-1-web.jpg"
                    className="d-block w-100 "
                    alt="image2"
                  />
                </div>
                <div className="carousel-item" data-bs-interval="2000">
                  <img
                    src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1649446353_April-9th_Banner-2-web.jpg"
                    className="d-block w-100 "
                    alt="image3"
                  />
                </div>
                <div className="carousel-item" data-bs-interval="2000">
                  <img
                    src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1648932088_web.jpg"
                    className="d-block w-100 "
                    alt="image4"
                  />
                </div>
                <div className="carousel-item" data-bs-interval="2000">
                  <img
                    src="	https://www.jiomart.com/images/cms/aw_rbslider/slides/1645559996_Summer_Store_1680x320.jpg"
                    className="d-block w-100 "
                    alt="image5"
                  />
                </div>
        ...
        <img
          src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1648705062_SRS_-1240-x-150_Free-Home-Delivery-Strip.jpg"
          width="100%"
        ></img>
                ...
                <div className="title">
                  <Link to="/product-category">
                    <a
                      ...
                      name=""
                      onClick={() => {
                        this.selectcategory(cat.id, cat.categoryName);
                      }}
                    >
                      <img
